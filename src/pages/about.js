...
export default function About(){
    return (
        ...
        <div className="container-fluid">
            <h3 className="text">Rodrigo D&iacute;az</h3>
                <p className="plainText center">
                    ...
                    Zealand I have gained experience in technical 
                    advisory roles within local government district 
                    planning, as well as freelance web development, 
                    hospitality and airline staffing.<br></br><br></br>
                    With strength in front end development, I enjoy working 
                    with customers developing websites and functional apps 
                    which deliver on their business needs and 
                    objectives. With my design background and prior 
                    experience in web development I have a keen eye 
                    for both aesthetics and functionality.<br></br><br></br>
                    Other people describe me as a perceptive, genuine and 
                    honest person 
                    ...
                    to detail, as a capable independent worked and someone 
                     ...
                     working with graphics, animation and robotics.</p>
        </div>
        </Layout>
    )
}